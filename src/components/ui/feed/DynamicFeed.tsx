...
const DynamicFeed: React.FC<DynamicFeedProps> = ({ feed, infoArea, className }) => {
  ...
  return (
    <div className={"h-fit min-w-fit max-w-full grid bg-blue-7 md:bg-white px-4 pb-[12vh] grid-cols-[repeat(auto-fill,minmax(calc((100vw-4rem)/2),1fr))] md:grid-cols-[repeat(auto-fill,minmax(188px,1fr))] auto-rows-[1px] " + className}>
