...
const DynamicFeed: React.FC<DynamicFeedProps> = ({ feed, infoArea, className, itemSize, deleteFolder, deleteItem, refreshItems }) => {
  ...
  return (
    <div className={"h-fit min-w-fit max-w-full grid bg-blue-7 md:bg-white md:dark:bg-transparent px-4 pb-[12vh] grid-cols-[repeat(auto-fill,minmax(calc((100vw-4rem)/2),1fr))] md:grid-cols-[repeat(auto-fill,minmax(calc((100vw-2rem)/5),1fr))] auto-rows-[1px] " + className}>
